...
| `TF_VAR_DNS_SERVICE_ID` | さくらのクラウドDNSサービスID | `123456789012` |
| `WS_GITHUB_CLIENT_ID` | Workspaces用 GitHub OAuth AppのClient ID | `Iv1.abc123...` |
| `WS_GITHUB_CLIENT_SECRET` | Workspaces用 GitHub OAuth AppのClient Secret | `abc123def456...` |
| `DOCS_GITHUB_CLIENT_ID` | Docs用 GitHub OAuth AppのClient ID | `Iv1.xyz789...` |
| `DOCS_GITHUB_CLIENT_SECRET` | Docs用 GitHub OAuth AppのClient Secret | `xyz789uvw012...` |
| `TARGET_ORGANIZATION` | アクセスを許可するGitHub組織名 | `your-company` |
...
TF_VAR_domain=...
TF_VAR_dns_service_id=...
WS_GITHUB_CLIENT_ID=...
WS_GITHUB_CLIENT_SECRET=...
DOCS_GITHUB_CLIENT_ID=...
DOCS_GITHUB_CLIENT_SECRET=...
TARGET_ORGANIZATION=...
```
